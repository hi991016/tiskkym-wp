<?php
    ...
    function add_page_to_admin_menu() {
        add_menu_page( 'CV', 'CV', 'manage_categories', 'post.php?post=12&action=edit', '','dashicons-admin-post', 4);
        add_menu_page( 'NEWS', 'NEWS', 'manage_categories', 'post.php?post=10&action=edit', '','dashicons-admin-post', 4);
    }
